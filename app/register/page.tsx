    ...
    <AuthLayout title={t("auth.register.title")} subtitle={t("auth.register.subtitle")}>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          />
          {errors.name && <p className="text-sm text-red-500 mt-1">{t("auth.validation.required")}</p>}
        </div>
        ...
        <div>
          ...
          />
          {errors.email && <p className="text-sm text-red-500 mt-1">{t("auth.validation.email")}</p>}
        </div>
        ...
        <div>
          ...
          <Input
            ...
            maxLength={14}
          />
          {errors.cpf && <p className="text-sm text-red-500 mt-1">{t("auth.validation.cpf")}</p>}
        </div>
        ...
        <div>
          ...
          <Select defaultValue="BR" onValueChange={(value) => setValue("country", value)}>
            <SelectTrigger id="country" className={errors.country ? "border-red-300" : ""}>
          ...
          {errors.country && <p className="text-sm text-red-500 mt-1">{t("auth.validation.required")}</p>}
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-muted-foreground">
            ...
            <Link href="/login" className="text-[#40A578] hover:underline font-medium">
