...
import { Home, Calendar, Bell, User, MessageCircleQuestion } from "lucide-react"
...
export default function Navigation() {
  ...
  const navItems = [
    ...
    { href: "/notifications", icon: Bell, label: t("nav.notifications"), badge: hasNotifications },
  ...
  const handleNavigation = (href: string) => {
    ...
    router.push(href)
    // Scroll para o topo após um pequeno delay para garantir que a navegação aconteceu
    setTimeout(() => {
